...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<String> text(String title) async {
    var out =
        await translator.translate(title, from: 'hi', to: 'en').toString();
    return out;
  }
...
//            ),
              ...
              children: [
                ...
                InkWell(
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                          height: 50, child: Image.asset('assets/special.png')),
                      Center(
                          child: Text(' Insider\nSpecial',
                              style: GoogleFonts.poppins(
                                  color: primarycolor,
    ...
    for (int i = 0; i < allcats.length; i++) {
      FirebaseFirestore.instance
          ...
          .where('category', isEqualTo: allcats[i].title)
                ...
                child: Column(
                  children: [
                    Container(
                        ...
                        child: Center(
                            child: Text(allcats[i].hindititle,
                                style: GoogleFonts.poppins(
                                    color: secondarycolor,
                                    fontSize:
                                        MediaQuery.of(context).size.height *
